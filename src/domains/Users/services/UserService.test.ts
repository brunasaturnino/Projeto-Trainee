import { Musics, Users } from "@prisma/client";
...
describe('haveUserListenedMusic', () => {
    ...
    test("invalid param ==> throw error", async () => {
        ...
        await expect(UserService.haveUserListenedMusic(-1, -1, currentUser as Users)).rejects.toThrow(
            new InvalidParamError('Invalid param')
        );
    ...
    test("see users history not being adm and not being yours ==> throw error", async () => {
        ...
        await expect(UserService.haveUserListenedMusic(1, 1, currentUser as Users)).rejects.toThrow(
            new Error('Only administrators can see users history freely')
        );
    ...
    test("user doesn't exists ==> throw error", async () => {
        ...
        await expect(UserService.haveUserListenedMusic(2, 1, currentUser as Users)).rejects.toThrow(
            new QueryError("This user doesn't exist")
        );
    ...
    test("see users history ==> true", async () => {
...
describe('userListenedMusic', () => {
    ...
    test("invalid param ==> throw error", async () => {
        ...
        await expect(UserService.userListenedMusic(-1, -1, currentUser as Users)).rejects.toThrow(
            new InvalidParamError('Invalid param')
        );
    ...
    test("adding music to users history not being adm and not being yours ==> throw error", async () => {
        ...
        await expect(UserService.userListenedMusic(1, 1, currentUser as Users)).rejects.toThrow(
            new Error('Only administrators can add musics to users history freely')
        );
    ...
    test("user doesn't exists ==> throw error", async () => {
        ...
        await expect(UserService.userListenedMusic(2, 1, currentUser as Users)).rejects.toThrow(
            new QueryError("This user doesn't exist")
        );
    ...
    test("update users history ==> true", async () => {
        ...
        await expect(UserService.userListenedMusic(2, 1, currentUser as Users)).resolves.toEqual(user);
